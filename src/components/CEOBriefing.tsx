...
interface CEOBriefingProps {
    efficiency?: number; // Now optional
    newsHeadline?: string;
}

// Then update the function signature to handle a default value:
export const CEOBriefing = ({ efficiency = 0, newsHeadline = "Market stable" }: CEOBriefingProps) => {
    // ... rest of the code
