    ...
    return [
      {
        ...
        description:
          "Briefing: Revenue growth of 19.7% outpaces sector volatility. Margin Impact: +4.2%. Executive Action: Squeeze Pro tier upgrades.",
        priority: "high",
        type: "trend",
      },
      {
        ...
        description:
          "Briefing: Revenue is up but efficiency at 78.1% indicates a margin leak. Margin Impact: -1.7%. Executive Action: Audit Vercel burn.",
        priority: "critical",
        type: "anomaly",
      },
      {
        ...
        description:
          "Briefing: Tech resilience detected while SPY dips. Margin Impact: +2.4%. Executive Action: Squeeze B2B budgets.",
        priority: "medium",
        type: "highlight",
      },
    ];
    ...
    return (data || [])
      .map(
        (coin: {
          ...
          id: coin.id,
          date: new Date(coin.last_updated || Date.now()).toLocaleDateString(
            "en-US",
          ...
          status:
            coin.price_change_percentage_24h > 0 ? "Completed" : "Pending",
        }),
      )
